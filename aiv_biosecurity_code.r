##Avian contact study: code to accompany the manuscript titled 
##'Biosecurity uptake and perceived risk of avian influenza among people in contact with birds in the UK' by H Whitlow et al 2025
##Author: Harry Whitlow
##Date of creation: 22/01/24
##Date of last edit: 22/04/25
##Data release: 080824v1

##
##Data are openly available at the University of Bristol Research Data Repository data.bris, at https://doi.org/10.5523/bris.3nmqsrbv5ruom2abn0ql6e8yh2
...
riskfig <- fig3a / fig3b+
  plot_annotation(tag_levels='a')
riskfig
ggsave("fig3_a_b_combined_risk_statements.jpg", riskfig, height=11, width=10, units=c("in"), dpi=900)
